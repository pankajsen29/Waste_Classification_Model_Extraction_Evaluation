...
# For each image: 
# - call target API
# - save predictions in target_results.jsonl
# - output: target_results.jsonl
#
...
def get_target_query_results(image_path):
    """
    Query target API and store results
    """
    query_status = True
    ...
    try:
        ...
        query_status = False
        print(f"Failed Target prediction for: {relative_path} -> {e}")
